          ...
          <div class="relative p-10 space-y-12 overflow-hidden md:grid md:grid-cols-2 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8 rounded-xl">
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Exploring Knowledge and Networking
                </p>
            ...
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Showcasing Innovation: Trade Shows and Expos
                </p>
                <ul role="list" class="pt-6 mt-6 space-y-6 border-t">
                  <span class="text-lg font-semibold text-neutral-600">
                    What's included?
            ...
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Building Stronger Teams: Team Building
                </p>
                <ul role="list" class="pt-6 mt-6 space-y-6 border-t">
                  <span class="text-lg font-semibold text-neutral-600">
                    What's included?
            ...
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Unveiling Innovation: Product Launches
                </p>
                <ul role="list" class="pt-6 mt-6 space-y-6 border-t">
                  <span class="text-lg font-semibold text-neutral-600">
                    What's included?
            ...
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Navigating Success: Corporate Meetings
                </p>
                <ul role="list" class="pt-6 mt-6 space-y-6 border-t">
                  <span class="text-lg font-semibold text-neutral-600">
                    What's included?
            ...
            <div class="relative flex flex-col p-8 bg-white">
              <div class="flex-1">
                ...
                <p class="mt-6 text-gray-500">
                  Shining Stars: Award Ceremonies
                </p>
                <ul role="list" class="pt-6 mt-6 space-y-6 border-t">
                  <span class="text-lg font-semibold text-neutral-600">
                    What's included?
